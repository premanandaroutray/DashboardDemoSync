...
import{NestedgridmodalComponent} from '../nestedgridmodal/nestedgridmodal.component'
declare var CanvasJS:any;
declare var $:any;
@Component({
  selector: 'app-drilldown-grid-easy-ui',
  templateUrl: './drilldown-grid-easy-ui.component.html',
  styleUrls: ['./drilldown-grid-easy-ui.component.css']
})
export class DrilldownGridEasyUIComponent implements OnInit {
dialogResult="";
  constructor(public dialog:MatDialog) { }
openDialog()
{
  let dialogRef=this.dialog.open(NestedgridmodalComponent,{
    width:'100%',
    height:'100%',
    
    data:'This text is passed into dialog'
  });
