...
//end region
  ...
  constructor(private _http:Http) { }
      ...
      postProjectDetails(proj:Projectdetail)
      {
        ...
        return this._http.post('http://'+localStorage.getItem('url_host').toString()+'/api/projects',body,requestOptions).map(x=>x.json());
      }
      putProjectDetails(id,proj)
      {
        ...
        return this._http.put('http://'+localStorage.getItem('url_host').toString()+'/api/projects'+id,body,requestOptions).map(res=>res.json());
      }
      ...
      {
        return this._http.delete('http://'+localStorage.getItem('url_host').toString()+'/api/projects'+id).map(res=>res.json());
      }
}
